...
public class BaseUtil {
    ...
    public void pCLoudy_Device_Full_Name() throws IOException {
        ...
        else
        {
            ...
            DeviceNames.add("Apple_iPhoneXR_Ios_14.7.1_e2255");
            DeviceNames.add("APPLE_iPhoneXSMax_Ios_15.0.0_9049f");
            DeviceNames.add("Apple_iPhoneXSMax_Ios_14.7.1_00b1e");
            DeviceNames.add("Apple_iPhoneXSMax_Ios_14.0.0_68985");
            DeviceNames.add("Apple_iPhone7plus_Ios_13.5.1_b1cc7");
            ...
            DeviceNames.add("Apple_iPhone7_Ios_13.1.3_316f0");
            DeviceNames.add("APPLE_iPhone8plus_Ios_13.1.2_dd878");
            DeviceNames.add("Apple_iPhone6S_Ios_14.4.0_dd19d");
            DeviceNames.add("Apple_iPhone8_Ios_14.7.1_5ef5e");
        ...
        while (true)
        {
            ...
            index = rand.nextInt(DeviceNames.size());

            //Storing any Random Element of AL in String
            String nextDevice = DeviceNames.get(index);

            if (API_Response.contains(nextDevice))
            {
                pCloudy_DeviceFullName = nextDevice;
                break;
            }

            //Removing unavailable devices from the list
